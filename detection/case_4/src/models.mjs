...
function reconcileByAttr(parentDom, newChildren, domAttr, treeField, doc) {
...
export const KeyedReconcile = {
  apply(parent, tree, doc) {
    reconcileByAttr(parent, tree.children || [], "data-key", "key", doc);
  },
};
...
export const ServerIdReconcile = {
  apply(parent, tree, doc) {
    reconcileByAttr(parent, tree.children || [], "data-server-id", "serverId", doc);
  },
};
